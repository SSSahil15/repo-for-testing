...
3. DevPulse exchanges the code for a GitHub Access Token, saves it securely in PostgreSQL (encrypted with AES-256-CBC), and signs a stateless DevPulse JWT.
...
- **Algorithm**: `HS256`
- **Validity**: **24 Hours** (Requires re-authentication upon expiration)
